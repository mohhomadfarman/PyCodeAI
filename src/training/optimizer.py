...
class AdamW(Adam):
    ...
    The standard Adam applies weight decay incorrectly (as L2 regularization
    added to gradients). AdamW fixes this by applying weight decay after
    the Adam update.
    
    This is the optimizer used by most modern language models!
    """
